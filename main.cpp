...
void applicationLoop() {
	...
	while (psi) {
		...
		modelMatrixColliderCasa = glm::scale(modelMatrixColliderCasa,
			glm::vec3(0.1, 0.1, 0.1));
		modelMatrixColliderCasa = glm::translate(
			modelMatrixColliderCasa, modelCasa.getObb().c);
		...
		modelMatrixColliderCasa2 = glm::scale(modelMatrixColliderCasa2,
			glm::vec3(0.1, 0.1, 0.1));
		modelMatrixColliderCasa2 = glm::translate(
			modelMatrixColliderCasa2, modelCasa2.getObb().c);
		...
		modelMatrixColliderCasa3 = glm::scale(modelMatrixColliderCasa3,
			glm::vec3(0.1, 0.1, 0.1));
		modelMatrixColliderCasa3 = glm::translate(
			modelMatrixColliderCasa3, modelCasa3.getObb().c);
		...
		modelMatrixColliderCasa4 = glm::scale(modelMatrixColliderCasa4,
			glm::vec3(0.1, 0.1, 0.1));
		modelMatrixColliderCasa4 = glm::translate(
			modelMatrixColliderCasa4, modelCasa4.getObb().c);
		...
		modelMatrixColliderCasa5 = glm::scale(modelMatrixColliderCasa5,
			glm::vec3(0.1, 0.1, 0.1));
		modelMatrixColliderCasa5 = glm::translate(
			modelMatrixColliderCasa5, modelCasa5.getObb().c);
		...
		modelMatrixColliderCasa6 = glm::scale(modelMatrixColliderCasa6,
			glm::vec3(0.1, 0.1, 0.1));
		modelMatrixColliderCasa6 = glm::translate(
			modelMatrixColliderCasa6, modelCasa6.getObb().c);
